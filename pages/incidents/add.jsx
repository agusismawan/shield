...
function addIncident() {
    ...
    useEffect(() => {
        axios
            .get("https://ularkadut.xyz/v1.0/parameters/urgency?isActive=Y")
            .then((response) => {
    ...
    useEffect(() => {
        axios
            .get("https://ularkadut.xyz/v1.0/parameters/impact?isActive=Y")
            .then((response) => {
                const data = response.data.data.map(d => ({ "value": d.id, "label": d.impact }))
    ...
    const handleSwitch = () => {
        if (enabled) {
            reset({ endTime: null, impactedSystem: '', idUrgency: null, idImpact: null, rootCause: "", actionItem: "", responsibleEngineer: "" })
            setEnabled(false);
        } else {
            setEnabled(true);
        }
                                ...
                                <div className="bg-white shadow overflow-hidden sm:rounded-lg static">
                                    <div className="border-gray-200 px-4 py-5 sm:px-6">
                                        <div className="grid grid-cols-6 gap-6">
                                            ...
                                            <div className="col-span-6 sm:col-span-3">
                                                <label className="mb-1 block text-sm font-medium text-gray-700">Log Start</label>
                                                <Controller
                                                    control={control}
                                                    rules={{ required: "This is required" }}
                                                    name="logStartTime"
                                                ...
                                                />
                                                {errors.logStartTime && <p className="mt-2 text-sm text-red-600">{errors.logStartTime.message}</p>}
                                            </div>
                                            ...
                                            {enabled === true &&
                                                <>
                                                    <div className="col-span-6 sm:col-span-3">
                                                        ...
                                                        />
                                                        {errors.endTime?.type === 'validate' && <p className="mt-2 text-sm text-red-600">End time must be greater than start time</p>}
                                                    ...
                                                    <div className="col-span-6 sm:col-span-6">
                                                        ...
                                                        />
                                                        {errors.idImpact && <p className="mt-2 text-sm text-red-600">{errors.idImpact.message}</p>}
                                                    </div>
                                                    <div className="col-span-6 sm:col-span-6">
                                                    ...
                                                    <div className="col-span-6 sm:col-span-6">
                                                        ...
                                                        />
                                                        {errors.rootCause && <p className="mt-2 text-sm text-red-600">{errors.rootCause.message}</p>}
                                                    </div>
                                                    <div className="col-span-6 sm:col-span-6">
                                                        ...
                                                        />
                                                        {errors.actionItem && <p className="mt-2 text-sm text-red-600">{errors.actionItem.message}</p>}
                                                    </div>
                                                    <div className="col-span-6 sm:col-span-6">
                                                        ...
                                                        />
                                                        {errors.responsibleEngineer && <p className="mt-2 text-sm text-red-600">{errors.responsibleEngineer.message}</p>}
                                                    </div>
                                                </>
                                            }
                                        </div>
